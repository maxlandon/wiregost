...
// Connector returns a core RPC client connection and stub to the caller.
type Connector func(config *assets.ClientConfig) (rpcpb.CoreClient, *grpc.ClientConn, error)
...
// ConnectClient - Connect to the wiregost server
func ConnectClient(config *assets.ClientConfig) (rpcpb.CoreClient, *grpc.ClientConn, error) {
	...
	return rpcpb.NewCoreClient(connection), connection, nil
}
