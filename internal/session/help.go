...
var endpointParams = []paramDescription{
	...
	{Name: "endpoint.certificate", Description: "Path to certificate needed for connection."},
	{Name: "endpoint.key", Description: "Path to private key needed for connection."},
