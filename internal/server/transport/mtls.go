...
// ConnectClient connects to the Wiregost RPC server locally.
func ConnectClient(_ *assets.ClientConfig) (rpcpb.CoreClient, *grpc.ClientConn, error) {
	...
	return rpcpb.NewCoreClient(conn), conn, nil
}
