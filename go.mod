module github.com/maxlandon/wiregost

go 1.13

require (
	github.com/InVisionApp/tabular v0.3.0 // indirect
	github.com/Ne0nd0g/merlin v0.8.0 // indirect
	github.com/apache/cloudstack-cloudmonkey v0.0.0-20191024102929-b040e85d70b8 // indirect
