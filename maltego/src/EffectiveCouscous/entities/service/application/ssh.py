...
class SSHService(MetasploitService):
    _category_ = 'Metasploit | Services | SSH'
...
class OpenSSH(SSHService):
    _category_ = 'Metasploit | Services | SSH'
    _namespace_ = 'EffectiveCouscous.MetasploitService.SSHService'
