...
class RDPService(MetasploitService):
    _category_ = 'Metasploit | Services | RDP'
...
class MicrosoftWindowsTerminal(RDPService):
    _category_ = 'Metasploit | Services | RDP'
    _namespace_ = 'EffectiveCouscous.MetasploitService.RDPService'
