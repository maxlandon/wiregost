...
class RPCService(MetasploitService):
    _category_ = 'Metasploit | Services | RPC'
...
class MicrosoftWindowsRPC(RPCService):
    _category_ = 'Metasploit | Services | RPC'
    _namespace_ = 'EffectiveCouscous.MetasploitService.RPCService'
