...
class VirtualizationSoftware(MetasploitService):
    _category_ = 'Metasploit | Services | Virtualization'
...
class VMWareWorkstation(VirtualizationSoftware):
    _category_ = 'Metasploit | Services | Virtualization'
    _namespace_ = 'EffectiveCouscous.MetasploitService.VirtualizationSoftware'
