...
class VPNService(MetasploitService):
    _category_ = 'Metasploit | Services | VPN'
...
class CiscoVPN(VPNService):
    _category_ = 'Metasploit | Services | VPN'
    _namespace_ = 'EffectiveCouscous.MetasploitService.VPNService'
