...
type Client struct {
	...
	*core.Interactive
	...
	// objects to the Session's Interactive stream, when transports are swaped/used/etc.
	//
...
func New(stream io.ReadWriteCloser) (c *Client) {
...
func (s *Client) SetupLog() (err error) {
...
func (s *Client) Cleanup() (err error) {
	return
}
