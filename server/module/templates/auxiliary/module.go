...
type AuxiliaryModule struct {
	templates.Module
}

// Instantiates a base module - Do not modify
func New() *AuxiliaryModule {
	return &AuxiliaryModule{templates.Module{}}
}

// Init - Module initialization, loads metadata. ** DO NOT ERASE **
func (s *AuxiliaryModule) Init() error {
...
func (s *AuxiliaryModule) Run() error {
